...
public class GlobalExceptionHandler {
  ...
  @ExceptionHandler({ResourceNotFoundException.class, RegistrationNotFoundException.class})
  ...
  public ResponseEntity<ApiError> handleInactiveAccount(UserAccountNotActiveException ex,
      HttpServletRequest request) {
  ...
  public ResponseEntity<ApiError> handleValidationException(MethodArgumentNotValidException ex,
    ...
    String message = ex.getBindingResult().getFieldErrors().stream()
        .map(error -> error.getField() + ": " + error.getDefaultMessage()).distinct()
