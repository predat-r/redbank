...
public class EmailTemplateService {
  ...
  public String buildTransferCompletedSenderHtml(String senderName, BigDecimal amount,
      String destAccount, String reference, OffsetDateTime timestamp) {
    ...
    return buildBaseHtmlTemplate(senderName, title, subtitle, badgeColor, badgeText, detailsHtml,
        "Need help? Contact RedBank support if you did not authorize this transaction.");
  }

  public String buildTransferCompletedReceiverHtml(String receiverName, BigDecimal amount,
      String sourceAccount, String reference, OffsetDateTime timestamp) {
    ...
    return buildBaseHtmlTemplate(receiverName, title, subtitle, badgeColor, badgeText, detailsHtml,
        "The funds are now available in your balance.");
  }

  public String buildTransferCancelledSenderHtml(String senderName, BigDecimal amount,
      String destAccount, String reference, String reason, OffsetDateTime timestamp) {
    ...
    String detailsHtml = buildDetailRow("Transaction Type", "Fund Transfer")
        ...
        + buildDetailRow("Recipient Account", destAccount)
        + buildDetailRow("Reference ID", reference)
        + buildDetailRow("Reason",
        reason != null && !reason.isBlank() ? reason : "Security / System cancellation")
        + buildDetailRow("Date & Time", formatDate(timestamp));
  ...
  public String buildDepositCompletedHtml(String accountHolderName, BigDecimal amount,
      String accountNumber, String reference, OffsetDateTime timestamp) {
    ...
    return buildBaseHtmlTemplate(accountHolderName, title, subtitle, badgeColor, badgeText,
        detailsHtml, "Your updated balance is reflected in your dashboard.");
  }

  public String buildWithdrawalCompletedHtml(String accountHolderName, BigDecimal amount,
      String accountNumber, String reference, OffsetDateTime timestamp) {
    ...
    return buildBaseHtmlTemplate(accountHolderName, title, subtitle, badgeColor, badgeText,
        detailsHtml,
        "If you did not make this withdrawal, please freeze your account immediately.");
  }

  public String buildStatementCompletedHtml(String accountHolderName, String accountNumber,
    ...
    String dateRange =
        (fromDate != null ? formatDate(fromDate) : "N/A") + " - " + (toDate != null ? formatDate(
            toDate) : "N/A");
    ...
    return buildBaseHtmlTemplate(accountHolderName, title, subtitle, badgeColor, badgeText,
        detailsHtml,
        "Please find your official PDF account statement attached to this email. For security, keep your financial statements confidential.");
  }

  private String buildDetailRow(String label, String value) {
    return "<tr>"
        + "<td style=\"padding: 10px 0; color: #64748b; font-size: 14px; font-weight: 500; border-bottom: 1px dashed #f1f5f9;\">"
        + label + "</td>"
        + "<td style=\"padding: 10px 0; color: #0f172a; font-size: 14px; font-weight: 600; text-align: right; border-bottom: 1px dashed #f1f5f9;\">"
        + value + "</td>"
        + "</tr>";
  }
  ...
  private String buildBaseHtmlTemplate(String recipientName, String title, String subtitle,
      String badgeColor, String badgeText, String detailsHtml, String footerNote) {
    return "<!DOCTYPE html>"
        + "<html>"
        + "<head>"
        + "<meta charset=\"UTF-8\">"
        ...
        + "<h1 style=\"color: #0f172a; margin: 0 0 6px 0; font-size: 24px; font-weight: 700; letter-spacing: -0.3px;\">"
        + title + "</h1>"
        ...
        + "<p style=\"color: #334155; font-size: 15px; margin-top: 0; margin-bottom: 20px;\">Hello <strong>"
        + (recipientName != null ? recipientName : "Valued Customer") + "</strong>,</p>"
        ...
        + "; color: #ffffff; font-size: 11px; font-weight: 700; padding: 5px 12px; border-radius: 20px; text-transform: uppercase; letter-spacing: 0.5px;\">"
        + badgeText + "</span>"
        + "</div>"
        ...
        // Note/Action
        + "<p style=\"color: #64748b; font-size: 13px; line-height: 1.6; margin: 0;\">" + footerNote
        + "</p>"
        + "</td></tr>"
